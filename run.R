...
# out_cdn = sprintf("../../non-equidistant_experiments/mimic_%stp_1measure_norm_%smispcnt_test/real/joint_rrg_only_sameXweight_em30_tune_lambda_100",tp,missing_pcnt*100)
